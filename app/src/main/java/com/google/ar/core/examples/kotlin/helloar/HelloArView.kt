...
class HelloArView(val activity: HelloArActivity) : DefaultLifecycleObserver {
  ...
  val buttonMoveForward = root.findViewById<Button>(R.id.button_move_forward)
  val buttonMoveBackward = root.findViewById<Button>(R.id.button_move_backward)
  val buttonMoveLeft = root.findViewById<Button>(R.id.button_move_left)
  val buttonMoveRight = root.findViewById<Button>(R.id.button_move_right)

  val buttonRotateLeft = root.findViewById<Button>(R.id.button_rotate_left)
  val buttonRotateRight = root.findViewById<Button>(R.id.button_rotate_right)
