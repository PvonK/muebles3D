...
class HelloArRenderer(
  ...
  val MeshPath: String,
  val PbrTexturePath: String,
  val AlbedoTexturePath: String,
  val AlbedoInstantPlacementTexturePath: String,
  ...
  private val modelPosition = Vector3(0f, 0f, 0f) // Initial position of the model
  private var modelRotation = Vector3(0f, 0f, 0f) // Initial rotation of the model
    ...
    try {
      ...
      virtualObjectAlbedoTexture =
        Texture.createFromAsset(
          render,
          AlbedoTexturePath,//"models/Chair_albedo.png",
          Texture.WrapMode.CLAMP_TO_EDGE,
      ...
      virtualObjectAlbedoInstantPlacementTexture =
        Texture.createFromAsset(
          render,
          AlbedoInstantPlacementTexturePath,//"models/Chair_albedo_instant_placement.png",
          Texture.WrapMode.CLAMP_TO_EDGE,
          Texture.ColorFormat.SRGB
        )
      ...
      val virtualObjectPbrTexture =
        Texture.createFromAsset(
          render,
          PbrTexturePath,//"models/Chair_Metallic.png",
          Texture.WrapMode.CLAMP_TO_EDGE,
          Texture.ColorFormat.LINEAR
        )
      virtualObjectMesh = Mesh.createFromAsset(render, MeshPath)//"models/Chair.obj")
      virtualObjectShader =
        Shader.createFromAssets(
            render,
  ...
  override fun onDrawFrame(render: SampleRender) {
    ...
    for ((anchor, trackable) in
      ...
      Matrix.translateM(modelMatrix, 0, modelPosition.x, modelPosition.y, modelPosition.z)
      //Matrix.rotateM(modelMatrix, 0, modelRotation.y, modelRotation.x, modelRotation.y, modelRotation.z)
  ...
  fun moveModelForward() {
    modelPosition.z += -0.05f
  }
  fun moveModelBackward() {
    modelPosition.z += 0.05f
  }
  fun moveModelLeft() {
  ...
  fun rotateModelClockwise() {
    modelRotation.y += 0.05f
  }

  fun rotateModelCounterClockwise() {
    modelRotation.y += 0.05f
  }

  private fun multiplyQuaternion(q1: Quaternion, q2: Quaternion): Quaternion {
    val w1 = q1.w
    val x1 = q1.x
    val y1 = q1.y
    val z1 = q1.z
